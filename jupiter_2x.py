...
WARNING: This script executes real transactions on Solana MAINNET if DRY_RUN=False, WHICH CAN RESULT IN FINANCIAL LOSS.

Set DRY_RUN = True in .env to log/simulate without submitting transactions (default: True for safety).
Set RECOVERY_ADDRESS = "5UfA6jjk6UopaGHMRzhDSubifwjC2r7F3zT91k9N1NnM" in .env.
Set BOT_WALLET_ADDRESS = "7sgkrWzMPA" in .env.
...
Set FERNET_SECRET and ENCRYPTED_SOL_KEY in .env for bot wallet.
Run locally or deploy on Render; call /sweep-back-immediate.
