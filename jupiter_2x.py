...
This script scans the entire transaction history of the bot wallets (7sgkwRP6ouNJtanoH6KpHvKPjhkhS1H1HimTFWWnzMPA and 5UfA6jjk6UopaGHMRzhDSubifwjC2r7F3zT91k9N1NnM), identifies all outgoing transfers and swaps, and attempts to reverse them by sending equivalent amounts back to the recovery wallet (5UfA6jjk6UopaGHMRzhDSubifwjC2r7F3zT91k9N1NnM) from the recipient addresses. It uses Jupiter for swaps if needed (e.g., token to SOL).
...
Set BOT_WALLETS = '["7sgkwRP6ouNJtanoH6KpHvKPjhkhS1H1HimTFWWnzMPA", "5UfA6jjk6UopaGHMRzhDSubifwjC2r7F3zT91k9N1NnM"]'.
...
BOT_WALLETS_JSON = os.getenv("BOT_WALLETS", '["7sgkwRP6ouNJtanoH6KpHvKPjhkhS1H1HimTFWWnzMPA", "5UfA6jjk6UopaGHMRzhDSubifwjC2r7F3zT91k9N1NnM"]')
...
Wallet decryption (for bot wallet)
def get_bot_wallet():
try:
...
return None
Get multi-wallets (for recipient test wallets)
...
Scan transactions and reverse outgoing transfers (if keys available)
